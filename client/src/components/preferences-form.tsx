        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              {/* Multi-day warning is web-only; hidden on native/local */}
              {!isLocalNative && form.watch('duration') === 'multiple days' && (
                <div className="text-red-600 font-semibold mt-2">
                  For multi-day trips, you must plan a trip itinerary (flights required). Location selection is disabled.
                </div>
              )}
